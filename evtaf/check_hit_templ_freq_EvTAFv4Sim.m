...
parameters.bird_name=currdir(slashes(end-2)+1:slashes(end-1)-1);
...
parameters.data_date=datestr(datenum(currdir(slashes(end-1)+1:slashes(end-1)+6), 'mmddyy'), 'ddmmmyyyy');
